...
public class SingleCheckButton extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
            attrs, R.styleable.SingleCheckButton, defStyle, 0);

        mExampleString = a.getString(
            R.styleable.SingleCheckButton_exampleString);
        mExampleColor = a.getColor(
            R.styleable.SingleCheckButton_exampleColor,
            mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
            R.styleable.SingleCheckButton_exampleDimension,
            mExampleDimension);


        if (a.hasValue(R.styleable.SingleCheckButton_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                R.styleable.SingleCheckButton_exampleDrawable);
